...
def gtk_call_once(func, *args):
    ...
    GLib.idle_add(wrap, args, priority=GLib.PRIORITY_DEFAULT)
...
def gtk_action_wait(func):
    ...
    def _call_method(*args):
        ...
        GLib.idle_add(_idle_method, (queue, args), priority=GLib.PRIORITY_DEFAULT)
        return queue.get()
...
def gtk_action_nowait(func):
    ...
    def _call_method(*args):
        ...
        GLib.idle_add(_idle_method, args, priority=GLib.PRIORITY_DEFAULT)
...
def gtk_batch_map(action, items, args=(), pre_func=None, batch_size=1):
    ...
    GLib.idle_add(process_one_batch, (item_queue, action, done_event), priority=GLib.PRIORITY_DEFAULT)
    done_event.wait()
