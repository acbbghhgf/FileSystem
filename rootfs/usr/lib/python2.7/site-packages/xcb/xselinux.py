...
class GetDeviceCreateContextReply(xcb.Reply):
    def __init__(self, parent, offset=0):
        xcb.Reply.__init__(self, parent, offset)
        (self.context_len,) = unpack_from('xx2x4xI20x', parent, offset)
        offset += 32
        self.context = xcb.List(parent, offset, self.context_len, 'b', 1)
...
class ListItem(xcb.Struct):
    def __init__(self, parent, offset):
        ...
        base = offset
        (self.name, self.object_context_len, self.data_context_len,) = unpack_from('III', parent, offset)
        offset += 12
        self.object_context = xcb.List(parent, offset, self.object_context_len, 'b', 1)
        offset += len(self.object_context.buf())
        offset += xcb.type_pad(1, offset)
        self.data_context = xcb.List(parent, offset, self.data_context_len, 'b', 1)
        offset += len(self.data_context.buf())
...
class ListPropertiesReply(xcb.Reply):
    def __init__(self, parent, offset=0):
        xcb.Reply.__init__(self, parent, offset)
        (self.properties_len,) = unpack_from('xx2x4xI20x', parent, offset)
        offset += 32
        self.properties = xcb.List(parent, offset, self.properties_len, ListItem, -1)
...
class ListSelectionsReply(xcb.Reply):
    def __init__(self, parent, offset=0):
        xcb.Reply.__init__(self, parent, offset)
        (self.selections_len,) = unpack_from('xx2x4xI20x', parent, offset)
        offset += 32
        self.selections = xcb.List(parent, offset, self.selections_len, ListItem, -1)
