...
AUDIT_CLASS_DIR_WRITE_N32 = _audit.AUDIT_CLASS_DIR_WRITE_N32
AUDIT_CLASS_CHATTR_N32 = _audit.AUDIT_CLASS_CHATTR_N32
AUDIT_CLASS_READ_N32 = _audit.AUDIT_CLASS_READ_N32
AUDIT_CLASS_WRITE_N32 = _audit.AUDIT_CLASS_WRITE_N32
AUDIT_CLASS_SIGNAL_N32 = _audit.AUDIT_CLASS_SIGNAL_N32
...
class audit_status(_object):
    ...
    if _newclass:feature_bitmap = _swig_property(_audit.audit_status_feature_bitmap_get, _audit.audit_status_feature_bitmap_set)
    def __init__(self): 
...
class audit_reply(_object):
    ...
    if _newclass:status = _swig_property(_audit.audit_reply_status_get, _audit.audit_reply_status_set)
    __swig_setmethods__["ruledata"] = _audit.audit_reply_ruledata_set
    __swig_getmethods__["ruledata"] = _audit.audit_reply_ruledata_get
    if _newclass:ruledata = _swig_property(_audit.audit_reply_ruledata_get, _audit.audit_reply_ruledata_set)
    __swig_setmethods__["login"] = _audit.audit_reply_login_set
    __swig_getmethods__["login"] = _audit.audit_reply_login_get
    if _newclass:login = _swig_property(_audit.audit_reply_login_get, _audit.audit_reply_login_set)
    __swig_setmethods__["message"] = _audit.audit_reply_message_set
    __swig_getmethods__["message"] = _audit.audit_reply_message_get
    if _newclass:message = _swig_property(_audit.audit_reply_message_get, _audit.audit_reply_message_set)
    __swig_setmethods__["error"] = _audit.audit_reply_error_set
    __swig_getmethods__["error"] = _audit.audit_reply_error_get
    if _newclass:error = _swig_property(_audit.audit_reply_error_get, _audit.audit_reply_error_set)
    ...
    if _newclass:signal_info = _swig_property(_audit.audit_reply_signal_info_get, _audit.audit_reply_signal_info_set)
    __swig_setmethods__["conf"] = _audit.audit_reply_conf_set
    __swig_getmethods__["conf"] = _audit.audit_reply_conf_get
    if _newclass:conf = _swig_property(_audit.audit_reply_conf_get, _audit.audit_reply_conf_set)
    def __init__(self): 
